  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`asset`)) {
        InlineResponse20074Object[['asset']] <-
          self$`asset`
      }
      if (!is.null(self$`avgAnnualInterestRate`)) {
        InlineResponse20074Object[['avgAnnualInterestRate']] <-
          self$`avgAnnualInterestRate`
      }
      if (!is.null(self$`canPurchase`)) {
        InlineResponse20074Object[['canPurchase']] <-
          self$`canPurchase`
      }
      if (!is.null(self$`canRedeem`)) {
        InlineResponse20074Object[['canRedeem']] <-
          self$`canRedeem`
      }
      if (!is.null(self$`dailyInterestPerThousand`)) {
        InlineResponse20074Object[['dailyInterestPerThousand']] <-
          self$`dailyInterestPerThousand`
      }
      if (!is.null(self$`featured`)) {
        InlineResponse20074Object[['featured']] <-
          self$`featured`
      }
      if (!is.null(self$`minPurchaseAmount`)) {
        InlineResponse20074Object[['minPurchaseAmount']] <-
          self$`minPurchaseAmount`
      }
      if (!is.null(self$`productId`)) {
        InlineResponse20074Object[['productId']] <-
          self$`productId`
      }
      if (!is.null(self$`purchasedAmount`)) {
        InlineResponse20074Object[['purchasedAmount']] <-
          self$`purchasedAmount`
      }
      if (!is.null(self$`status`)) {
        InlineResponse20074Object[['status']] <-
          self$`status`
      }
      if (!is.null(self$`upLimit`)) {
        InlineResponse20074Object[['upLimit']] <-
          self$`upLimit`
      }
      if (!is.null(self$`upLimitPerUser`)) {
        InlineResponse20074Object[['upLimitPerUser']] <-
          self$`upLimitPerUser`
      }
    ...
    fromJSON = function(InlineResponse20074Json) {
      ...
      if (!is.null(InlineResponse20074Object$`asset`)) {
        self$`asset` <- InlineResponse20074Object$`asset`
      }
      if (!is.null(InlineResponse20074Object$`avgAnnualInterestRate`)) {
        self$`avgAnnualInterestRate` <- InlineResponse20074Object$`avgAnnualInterestRate`
      }
      if (!is.null(InlineResponse20074Object$`canPurchase`)) {
        self$`canPurchase` <- InlineResponse20074Object$`canPurchase`
      }
      if (!is.null(InlineResponse20074Object$`canRedeem`)) {
        self$`canRedeem` <- InlineResponse20074Object$`canRedeem`
      }
      if (!is.null(InlineResponse20074Object$`dailyInterestPerThousand`)) {
        self$`dailyInterestPerThousand` <- InlineResponse20074Object$`dailyInterestPerThousand`
      }
      if (!is.null(InlineResponse20074Object$`featured`)) {
        self$`featured` <- InlineResponse20074Object$`featured`
      }
      if (!is.null(InlineResponse20074Object$`minPurchaseAmount`)) {
        self$`minPurchaseAmount` <- InlineResponse20074Object$`minPurchaseAmount`
      }
      if (!is.null(InlineResponse20074Object$`productId`)) {
        self$`productId` <- InlineResponse20074Object$`productId`
      }
      if (!is.null(InlineResponse20074Object$`purchasedAmount`)) {
        self$`purchasedAmount` <- InlineResponse20074Object$`purchasedAmount`
      }
      if (!is.null(InlineResponse20074Object$`status`)) {
        self$`status` <- InlineResponse20074Object$`status`
      }
      if (!is.null(InlineResponse20074Object$`upLimit`)) {
        self$`upLimit` <- InlineResponse20074Object$`upLimit`
      }
      if (!is.null(InlineResponse20074Object$`upLimitPerUser`)) {
        self$`upLimitPerUser` <- InlineResponse20074Object$`upLimitPerUser`
      }
      self
    },
