...
#' @docType class
#' @title InlineResponse20018
#'
#' @description InlineResponse20018 Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field rows  list( \link{InlineResponse20018Rows} ) 
#'
#' @field total  integer 
#'
  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`rows`)) {
        InlineResponse20018Object[['rows']] <-
          lapply(self$`rows`, function(x) x$toJSON())
      }
      if (!is.null(self$`total`)) {
        InlineResponse20018Object[['total']] <-
          self$`total`
      }
    ...
    fromJSON = function(InlineResponse20018Json) {
      ...
      if (!is.null(InlineResponse20018Object$`rows`)) {
        self$`rows` <- ApiClient$new()$deserializeObj(InlineResponse20018Object$`rows`, "array[InlineResponse20018Rows]", loadNamespace("binanceRapi"))
      }
      if (!is.null(InlineResponse20018Object$`total`)) {
        self$`total` <- InlineResponse20018Object$`total`
      }
      self
    },
