...
context("Test SubAccountUSDTFuturesSummaryFutureAccountSummaryRespSubAccountList")

model.instance <- SubAccountUSDTFuturesSummaryFutureAccountSummaryRespSubAccountList$new()
