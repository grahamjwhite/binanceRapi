...
context("Test InlineResponse20036Data")

model.instance <- InlineResponse20036Data$new()
...
test_that("triggerCondition", {
  # tests for the property `triggerCondition` (InlineResponse20036DataTriggerCondition)
...
test_that("indicators", {
  # tests for the property `indicators` (InlineResponse20036DataIndicators)
