...
context("Test MarginStreamApi")

api.instance <- MarginStreamApi$new()

test_that("SapiV1UserDataStreamDelete", {
  # tests for SapiV1UserDataStreamDelete
...
test_that("SapiV1UserDataStreamPost", {
  # tests for SapiV1UserDataStreamPost
  # base path: https://api.binance.com
...
test_that("SapiV1UserDataStreamPut", {
  # tests for SapiV1UserDataStreamPut
  # base path: https://api.binance.com
