...
context("Test InlineResponse20037UserAssetDribblets")

model.instance <- InlineResponse20037UserAssetDribblets$new()
...
test_that("userAssetDribbletDetails", {
  # tests for the property `userAssetDribbletDetails` (array[InlineResponse20037UserAssetDribbletDetails])
