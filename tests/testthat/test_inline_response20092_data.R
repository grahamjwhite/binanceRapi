...
context("Test InlineResponse20092Data")

model.instance <- InlineResponse20092Data$new()

test_that("profitTransferDetails", {
  # tests for the property `profitTransferDetails` (array[InlineResponse20092DataProfitTransferDetails])
