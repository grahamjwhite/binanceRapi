...
context("Test InlineResponse200104")

model.instance <- InlineResponse200104$new()
...
test_that("liquidity", {
  # tests for the property `liquidity` (SapiV1BswapLiquidityLiquidity)
...
test_that("share", {
  # tests for the property `share` (SapiV1BswapLiquidityShare)
